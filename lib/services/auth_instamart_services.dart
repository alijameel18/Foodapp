...
class AuthServiceInstamart {

  // Login function specifically for Instamart Partners
  Future<void> instamartLogin(Map<String, String> data, BuildContext context) async {
    try {
      ...
      // 3. --- Check Firestore for INSTAMART data ---
      // We look in 'instamart_requests' collection
      ...
      if (!docSnapshot.exists) {
        ...
        throw Exception("No Instamart store account found. Please register first.");
      }
      ...
      if (status == 'pending') {
        ...
        throw Exception("Your store account is still under review by Admin.");
      }
      ...
      // The AuthGateInstamart or Login Page navigation logic will take over.
