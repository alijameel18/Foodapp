...
class RiderRegisterWithImage extends StatefulWidget {
  const RiderRegisterWithImage({super.key});

  @override
  State<RiderRegisterWithImage> createState() => _RiderRegisterWithImageState();
}

class _RiderRegisterWithImageState extends State<RiderRegisterWithImage> {
  ...
  final String uploadPreset = 'restaurant_upload'; // You can reuse this or make 'rider_upload'
  ...
  Future<void> _submitForm() async {
    ...
    if (_selectedImage == null) {
      _showError('Please upload a profile or license photo.');
      return;
    }
    ...
    try {
      ...
      // Step D: Save to Firestore (Collection: rider_requests)
      await FirebaseFirestore.instance.collection('rider_requests').doc(user.uid).set({
        'uid': user.uid,
        'name': _nameController.text.trim(), // Rider Name
        'email': _emailController.text.trim(),
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // --- IMAGE UPLOADER ---
                        const Text("Profile / Vehicle Photo", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                        const SizedBox(height: 20),
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: _selectedImage == null
                              ...
                              children: [
                                Icon(Icons.camera_alt_outlined, size: 50, color: themeColor.withOpacity(0.5)),
                                const SizedBox(height: 8),
                                Text("Tap to upload photo", style: TextStyle(color: Colors.grey[700])),
                              ],
                            )
                                : Container(
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(icon, color: themeColor), // Blue Icons
